...
class CameraViewController: UIViewController, AVCaptureFileOutputRecordingDelegate {
  ...
  func changeCamera() {
    ...
    sessionQueue.async {
      ...
      DispatchQueue.main.async {
        ...
        self.delegate.shouldEnableRecordUI(enable: self.movieFileOutput != nil)
  ...
  private func addObservers() {
    let keyValueObservation = session.observe(\.isRunning, options: .new) { _, change in
      ...
      DispatchQueue.main.async {
        ...
        self.delegate.shouldEnableRecordUI(enable: isSessionRunning && self.movieFileOutput != nil)
  ...
  func sessionInterruptionEnded(notification: NSNotification) {
    ...
    if let resumeIsHidden = resumeButton?.isHidden, !resumeIsHidden {
      UIView.animate(withDuration: 0.25,
                     animations: {
    ...
    if let cameraUnLabelIsHidden = cameraUnavailableLabel?.isHidden, !cameraUnLabelIsHidden {
      UIView.animate(withDuration: 0.25,
                     animations: {
